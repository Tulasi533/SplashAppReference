...
import 'package:splash_app/AdminFlow/ManageAdmin/DeleteCancelAdmin.dart';
...
class DeleteAdminPage extends StatefulWidget {
  const DeleteAdminPage({ Key? key }) : super(key: key);

  @override
  State<DeleteAdminPage> createState() => _DeleteAdminPageState();
}
                  ...
                  child:ListTile(
                    onTap: () {
                      Navigator.push(
                        context, 
                        MaterialPageRoute(
                          builder: (context) => DeleteCancelAdmin(adminId: d.adminid)
                        )
                      );
                    },
